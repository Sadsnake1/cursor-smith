...
import { CANVAS_REGION_GRID, CANVAS_REGION_MARGIN_X, CANVAS_REGION_MOTION_PAD, CANVAS_REGION_SHRINK_MS, CARET_STATE_FIELDS, CARET_STYLE_TTL_MS, INPUT_HOT_MS, FIREWORK_ALPHA, FIREWORK_CELL, FIREWORK_FALL_MS, FIREWORK_GRAVITY, FIREWORK_MAX_LIVE, FIREWORK_MIN_GAP_MS, FIREWORK_PALETTE_MAX, FIREWORK_PRESSURE, FIREWORK_RISE_MS, FIREWORK_SECOND_MAX, FIREWORK_SECOND_SPARKS, FIREWORK_SPARK_BUDGET, FIREWORK_SPARK_MIN, FIREWORK_TRAIL_LEN, FIREWORK_TWINKLE_AT, FRAME_CAPS, GEOMETRY_TTL_MS, GLOW_HEAT_GAIN, SECONDARY_FULL_MAX, SMEAR_SETTLE_V, SPEED_RAMP_LIFTOFF, STARDUST_MAX_PER_CARET, TORCH_CANVAS_SCALE, TORCH_FLICKER_WEIGHTS } from "./constants";
