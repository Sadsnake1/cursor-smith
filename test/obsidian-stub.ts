...
export class PluginSettingTab { updates?: number; refreshes?: number; constructor(..._args: any[]) {} hide() {} update() { this.updates = (this.updates || 0) + 1; } refreshDomState() { this.refreshes = (this.refreshes || 0) + 1; } }
